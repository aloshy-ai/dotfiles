...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "aloshy.🅰🅸"
    user-mail-address "noreply@aloshy.ai")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/aloshy/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/aloshy/bin" "/profile/bin" "/Users/aloshy/.npm-packages/bin" "/Users/aloshy/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
